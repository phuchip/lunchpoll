                    ...
                    <div class="tb">
                        <div class="td">
                            <div class="tb" id="p-tabs-m">
                                <div class="td active"><i class="fa fa-home"></i><span></span></div>
                                <div class="td"><i class="fa fa-users"></i><span></span></div>
                                <div class="td"><i class="fa fa-picture-o"></i><span></span></div>
                                <div class="td"><i class="fa fa-comments-o"></i><span></span></div>
                                <div class="td"><i class="fa fa-cogs"></i><span></span></div>
                            </div>
                        </div>
                    </div>
                </div>
