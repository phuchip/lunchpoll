    ...
    <div id="profile-upper">
        ...
        <div id="profile-d">
            ...
            <div class="tb" id="m-btns">
                ...
                <div class="td">
                    <div class="m-btn change-password" data-toggle="modal" data-target="#change_password"><i class="material-icons">lock</i><span>Change Password</span></div>
                </div>
            </div>
...
<?php $this->load->view('modal/change_password'); ?>